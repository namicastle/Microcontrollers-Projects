...
#define KEY             PORTDbits.RD3                                           // define Key LEDe
...
void main()
{
	...
	Init_Interrupt();                                                           // call interruptt
    ...
    while(1)                                                                    // while loop
    {
        ...
        {                                                                       // temperature in fahrenheit and celcius
            ...
            int rpm = get_RPM();                                                // readout of rpm
            Set_RPM_RGB(rpm);
        ...
        if (Nec_OK == 1)                                                        // if Nec_OK is 1
        {
            ...
            if (found == 5)                                                     // if the first button is pressed
            {
                Toggle_Fan();                                                   // then reset to the original time initialized     
            }
            if (found == 6)                                                     // if the first button is pressed
            {
                Decrease_Speed();                                               // then reset to the original time initialized     
            }
            if (found == 7)                                                     // if the first button is pressed
            {
                Increase_Speed();                                               // then reset to the original time initialized     
            }
            ...
            Do_Beep();                                                          // remove beep tone
            do_update_pwm(duty_cycle);                                          // call this function every time use do beep
            KEY = 0; 
        }    
    }  
}
