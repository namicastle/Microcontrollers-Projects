...
void Update_Screen(void)
{
    ...
    Fan_Set_Temp_Txt[0] = fan_set_temp/100 + '0';                               // Hundreds digit of fan temp
    Fan_Set_Temp_Txt[1] = (fan_set_temp%100)/10 + '0';                          // Tens digit of fan temp
    Fan_Set_Temp_Txt[2] = fan_set_temp%10 + '0';                                // Ones digit of fan temp
    ...
    DC_Txt[0] = duty_cycle/100 + '0';                                           // Hundreds digit of duty_cycle
    DC_Txt[1] = duty_cycle/10 + '0';                                            // Tens digit of duty_cycle
    DC_Txt[2] = duty_cycle%10 + '0';                                            // Ones digit of duty_cycle
    
    Volt_Txt[0] = ((int)  volt        ) + '0';                                  // Hundreds digit of volt
    Volt_Txt[2] = (((int)(volt* 10.00))%10) + '0';                              // Tens digit of volt
    Volt_Txt[3] = (((int)(volt* 100.00))%10) + '0';                             // Ones digit of volt
